...
as well as interfacing to external kinematics generators.  The [GEANT4
output](./doc/OUTPUT.md) is made available by registering a user class
derived from EDepSim::PersistencyManager (which will fully marshal the
information). A default EDepSim::RootPersistencyManager is provided to save
the generated events to a ROOT tree.
