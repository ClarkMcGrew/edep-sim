////////////////////////////////////////////////////////////
// $Id: DSimUserPrimaryGeneratorAction.hh,v 1.7 2012/05/10 16:27:26 mcgrew Exp $
//

#ifndef DSimPrimaryGeneratorAction_hh
#define DSimPrimaryGeneratorAction_hh 1
...
class DSimUserPrimaryGeneratorMessenger;
...
public:
    DSimUserPrimaryGeneratorAction(void);
    virtual ~DSimUserPrimaryGeneratorAction();
    ...
    /// Add a new DSimPrimaryGenerator to the list of generators adding
...
private:
    ...
    DSimUserPrimaryGeneratorMessenger* fMessenger;
};
#endif
