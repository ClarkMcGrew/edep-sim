////////////////////////////////////////////////////////////
// $Id: DSimSDFactory.hh,v 1.1 2004/12/04 17:33:13 jnurep Exp $
//
#ifndef DSimSDFactory_hh_seen
#define DSimSDFactory_hh_seen
...
public:
    ...
    DSimSDFactory(G4String type);
    virtual ~DSimSDFactory();
