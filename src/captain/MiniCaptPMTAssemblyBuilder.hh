#ifndef MiniCaptPMTAssemblyBuilder_hh_Seen
#define MiniCaptPMTAssemblyBuilder_hh_Seen

#include "DSimBuilder.hh"

class G4LogicalVolume;

/// Construct the PMT assembly for the mini CAPTAIN detector.  The location of
/// the PMT Assembly is relative to the "top" surface, and the PMTs face "up".
/// The assembly is a half hexagon.
class MiniCaptPMTAssemblyBuilder : public DSimBuilder {
public:
    MiniCaptPMTAssemblyBuilder(G4String name, DSimBuilder* parent)
        : DSimBuilder(name,parent) {Init();};
    virtual ~MiniCaptPMTAssemblyBuilder();
