#ifndef DSimVConstrainedPositionGenerator_hh_seen
#define DSimVConstrainedPositionGenerator_hh_seen
...
class DSimVConstrainedPositionGenerator : public DSimVPositionGenerator {
public:
    DSimVConstrainedPositionGenerator(const G4String& name);
    virtual ~DSimVConstrainedPositionGenerator();
