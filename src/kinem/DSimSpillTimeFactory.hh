#ifndef DSimSpillTimeFactory_hh_seen
#define DSimSpillTimeFactory_hh_seen
...
/// DSimSpillTimeGenerator object.
class DSimSpillTimeFactory : public DSimVTimeFactory {
public:
    DSimSpillTimeFactory(DSimUserPrimaryGeneratorMessenger* parent);
    virtual ~DSimSpillTimeFactory();
    ...
    /// will cross the center of the DSim hall.
