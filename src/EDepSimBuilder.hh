#ifndef EDepSim_Builder_hh_Seen
#define EDepSim_Builder_hh_Seen
...
/// classes should be named "EDepSim::<thename>Builder".  When builders are used in
...
public:
    ...
    template <class T> T& Get(G4String n) {
        ...
        if (p==fSubBuilders.end()) {
            ...
            EDepSimThrow(" Undefined constructor");
        }
...
namespace EDepSim {class BuilderMessenger;}
class EDepSim::BuilderMessenger: public G4UImessenger {
private:
