////////////////////////////////////////////////////////////
// $Id: DSimRootGeometryManager.hh,v 1.13 2011/01/17 02:45:46 mcgrew Exp $
// 
#ifndef DSimRootGeometryManager_hh_Seen
#define DSimRootGeometryManager_hh_Seen
...
public:
    virtual ~DSimRootGeometryManager();

    /// If a persistency manager has not been created, create one.
    static DSimRootGeometryManager* Get(void);
...
private:
    ...
    static DSimRootGeometryManager* fThis;
