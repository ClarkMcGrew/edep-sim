...
// HEP).  And copied from the GEANT4 CLHEP into the EDepSim i/o library to
// specify the units being used in the i/o classes.  These match the internal
// GEANT4 units.
//
// All of the definitions have been placed into the EDepSim namespace to avoid
// conflicts.  The "unit" namespace can be used as an alternative by defining
// "USE_UNIT_NAMESPACE".
//
// The basic units are :
...
#ifndef EDepSimUnits_h_Seen
#define EDepSimUnits_h_Seen

#ifdef USE_UNIT_NAMESPACE
namespace unit {
#else
namespace EDepSim {
#endif
